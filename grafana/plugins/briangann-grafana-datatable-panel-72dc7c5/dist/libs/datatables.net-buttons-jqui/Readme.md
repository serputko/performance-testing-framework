# Buttons for DataTables with styling for [jQuery UI](http://jqueryui.com/)

This package contains distribution files required to style [Buttons extension](https://datatables.net/extensions/buttons) for [DataTables](https://datatables.net/) with styling for [jQuery UI](http://jqueryui.com/).
