# Responsive for DataTables with styling for [jQuery UI](http://jqueryui.com/)

This package contains distribution files required to style [Responsive extension](https://datatables.net/extensions/responsive) for [DataTables](https://datatables.net/) with styling for [jQuery UI](http://jqueryui.com/).
