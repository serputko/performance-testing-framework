# DataTables for jQuery with styling for [Zurb Foundation](http://foundation.zurb.com/)

This package contains distribution files required to style [DataTables library](https://datatables.net) for [jQuery](http://jquery.com/) with styling for [Zurb Foundation](http://foundation.zurb.com/).
...
```
bower install --save datatables.net-zf
```
